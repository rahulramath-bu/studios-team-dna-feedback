...
export function TeamLeftRail({
  ...
  const showSwitcherCaret = teamOptions.length > 0 || canManageTeam;
            ...
            {otherTeams.length > 0 ? (
              <div className="team-left-nav-menu-section">
                ...
                {otherTeams.map((team) => (
                  ...
                  >
                    <span className="team-left-nav-menu-item-mark" aria-hidden="true">
                      {team.name?.trim().charAt(0).toUpperCase() || '?'}
                    </span>
                    <span className="team-left-nav-menu-item-copy">
                      <span className="team-left-nav-menu-item-name">{team.name}</span>
                      {team.teamType ? (
