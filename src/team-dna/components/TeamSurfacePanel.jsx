        ...
        <>
          ...
          >
            ...
            <div className="team-surface-panel-body">
              ...
              {surface === 'pulse' ? <PulseRows /> : <CoachingRows />}
              <button
                type="button"
            ...
            <footer className="team-surface-panel-footer">
              <button type="button" className="bu-button bu-button--secondary" onClick={onClose}>
                {meta.secondary}
              </button>
              <button type="button" className="bu-button bu-button--primary" onClick={onClose}>
                {meta.primary}
              </button>
            </footer>
          </motion.aside>
    ...
    <section className="team-surface-rows" aria-label="Pulse categories">
      ...
      <ul className="team-surface-rows-list">
        {PULSE_CATEGORIES.map((category) => (
          <li key={category.name} className="team-surface-row">
            <span className="team-surface-row-name">{category.name}</span>
            <span className="team-surface-row-aside">
              {category.score !== null ? (
                <>
                  <span className="team-surface-row-meta">{category.lastUsed}</span>
                  <span className="team-surface-row-score">
                    {category.score}
                    <span
                      className="team-surface-row-delta"
                      data-tone={category.delta?.startsWith('+') ? 'up' : 'down'}
                    >
                      {category.delta}
                    </span>
                  </span>
